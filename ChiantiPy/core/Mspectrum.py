...
class mspectrum(ionTrails, specTrails):
    ...
    """
    def __init__(self, temperature, eDensity, wavelength, filter=(chfilters.gaussianR, 1000.), label=False,
        elementList = None, ionList = None, minAbund=None, keepIons=False, abundance=None,  doLines=True,
        ...
        :param timeout: used in the multiprocessing module, defaults to 0.1
