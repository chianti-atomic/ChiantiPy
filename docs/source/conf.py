...
sys.path.insert(0,os.path.abspath('../../chianti/'))
...
if on_rtd:
    ...
    MOCK_MODULES = ['scipy','pyzmq','matplotlib']
...
latex_documents = [
    (master_doc, 'ChiantiPy.tex', u'ChiantiPy Documentation',
     u'Ken Dere', 'manual'),
]
...
man_pages = [
    (master_doc, 'chiantipy', u'ChiantiPy Documentation',
     [author], 1)
]
